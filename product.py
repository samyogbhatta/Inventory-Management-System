...
class productClass:
    def __init__(self, root):
        ...
        # Title
        title = Label(product_Frame, text="Manage Product Details", font=("times new roman", 18, "bold"), bg="#1e3c72", fg="white")
        title.pack(side=TOP, fill=X)

        lbl_category = Label(product_Frame, text="Category", font=("times new roman", 15), bg="white")
        lbl_category.place(x=30, y=60)
        lbl_supplier = Label(product_Frame, text="Supplier", font=("times new roman", 15), bg="white")
        lbl_supplier.place(x=30, y=110)
        lbl_product_name = Label(product_Frame, text="Name", font=("times new roman", 15), bg="white")
        lbl_product_name.place(x=30, y=160)
        lbl_price = Label(product_Frame, text="Price", font=("times new roman", 15), bg="white")
        lbl_price.place(x=30, y=210)
        lbl_qty = Label(product_Frame, text="Quantity", font=("times new roman", 15), bg="white")
        lbl_qty.place(x=30, y=260)
        lbl_status = Label(product_Frame, text="Status", font=("times new roman", 15), bg="white")
        ...
        # Buttons
        btn_add = Button(product_Frame, text="Save", command=self.add, font=("times new roman", 15), bg="#3498db", fg="white", cursor="hand2")
        btn_add.place(x=10, y=400, width=100, height=40)
        btn_update = Button(product_Frame, text="Update", command=self.update, font=("times new roman", 15), bg="#2ecc71", fg="white", cursor="hand2")
        btn_update.place(x=120, y=400, width=100, height=40)
        btn_delete = Button(product_Frame, text="Delete", command=self.delete, font=("times new roman", 15), bg="#e74c3c", fg="white", cursor="hand2")
        btn_delete.place(x=230, y=400, width=100, height=40)
        btn_clear = Button(product_Frame, text="Clear", command=self.clear, font=("times new roman", 15), bg="#95a5a6", fg="white", cursor="hand2")
