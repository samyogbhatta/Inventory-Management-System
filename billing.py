...
class billClass:
    def __init__(self,root):
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="Inventory Management System | Developed by ......\nFor any Technical Issues Contact:.........",font=("times new roman",10),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#---------------------- all functions ------------------------------
    ...
    def generate_bill(self):
        if self.var_cname.get()=="" or self.var_contact.get()=="":
            ...
            fp=open(f'{bill_path}\\{str(self.invoice)}.txt','w')
